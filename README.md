...
- **카메라 자연 사각지대**: D455 RGB 수직 FOV 58° + 카메라 높이 0.995 m + pitch≈0 → 전방 약 2.2 m 이하 ground 가 카메라에 안 보임. BEV 하단부가 항상 default 노랑. 가까운 정적 장애물(연석, 쓰레기통 등)은 동적 파이프라인(YOLO)만 잡을 수 있어 안전 사각지대. **카메라 down-pitch 또는 보조 센서(소나/lidar) 가 권장 해결책(약 5–10° 정도)**.
